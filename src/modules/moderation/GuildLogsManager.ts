 ...
 */
const AuditLogEventValues: (string | AuditLogEvent)[] =
    Object
        .values(AuditLogEvent)
        .filter((value: string | AuditLogEvent): boolean => typeof value === "string");
...
export class GuildLogsManager {
     ...
     */
    private readonly _savedLogs: Collection<typeof Guild.prototype["id"], typeof AuditLogEventValues> = new Collection();
    /**
